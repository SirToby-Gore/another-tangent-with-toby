...
<main class="hero">
    <div class="container">
        ...
        <p class="subtitle"><?php echo htmlspecialchars($showSlogan); ?></p>
        ...
        <div class="meta-pills">
            <div class="pill">
                ...
                <?php echo htmlspecialchars($broadcastTime); ?>
            </div>
            <div class="pill">
                <svg fill="currentColor" viewBox="0 0 16 16">
                    <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z" />
                </svg>
                <?php echo htmlspecialchars($studioLoc); ?>
            </div>
            <div class="pill">
                <svg fill="currentColor" viewBox="0 0 16 16">
                    <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                </svg>
                Hosted by <?php echo htmlspecialchars($hostName); ?>
            </div>
        </div>
    </div>
</main>